...
import console.gamerunner.Command.OutputCommand;
...
public class ConsoleGameRunner {
    ...
    protected static Log log = LogFactory.getLog(ConsoleGameRunner.class);
     ...
     */
    public ConsoleGameRunner(Properties properties) {
        try {
    ...
    public void start() {
        ...
        writeResults(getJSONResult());
    }

    void writeResults(String s) {
        try {
            FileWriter fw = new FileWriter("c:\\logs\\results.json");
            fw.write(s);
            fw.close();
		} catch (IOException e) {
			e.printStackTrace();
